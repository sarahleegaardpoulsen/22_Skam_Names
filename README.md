...
To get the datasets we have been in contact with Dorthe Larsen from Danmarks Statestik and received the data through email. We were able to share these data aslong as we clearly state that is is from Danmarks Statistik. The data is available above.
